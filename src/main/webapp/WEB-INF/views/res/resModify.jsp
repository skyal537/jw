				...
				<tr>
					...
					<input type="hidden" name="resId" value="${res.resId}">
						<select name="accountBank">
							...
							<option value="우리은행"  ${res.accountBank eq "우리은행"? 'selected':'' } data-account="045-10210-454685" >우리은행</option>
							<option value="농협" ${res.accountBank eq "농협"? 'selected':'' }    data-account="309-8457-74587">농협</option>
							<option value="국민은행" ${res.accountBank eq "국민은행"? 'selected':'' }   data-account="123-45678-12354">국민은행</option>
							<option value="신한은행" ${res.accountBank eq "신한은행"? 'selected':'' }  data-account="99658-12345">신한은행</option>
					</select></td>
				</tr>
				<tr>
					<th>결제계좌</th>
