...
<form action="tProdRegist.do" method="post">
<div class="container">
		...
		<table  class="grid table table-bordered table-striped hover ">
			...
			<tr>
				<th>상품아이디</th>
				<td><input value="" name="productId"></td>
			</tr>
			<tr>
				<th>상품이름</th>
				<td><input value="" name="productName"></td>
			</tr>
			<tr>
				<th>출발일자</th>
				<td><input value="" name="startDate"></td>
			</tr>
			<tr>
				<th>도착일자</th>
				<td><input value="" name="endDate"></td>
			</tr>
			<tr>
				<th>총인원</th>
			...
			<tr>
				<th>항공사</th>
				<td><input value="" name="airLineNm"></td>
			</tr>
			<tr>
				<th>계좌은행</th>
