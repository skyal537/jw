...
<div class="container">
	...
	<form name="tx_editor_form" action="postReplyRegist.do" method="post" onsubmit="return false;">
	    ...
	    <table class="table table-striped table-bordered ">
	        ...
	        <tr>
	            ...
	            <td><input type="text" name="memIdArrv" value="${post.memIdSend }" Class="form-control input-sm"></td>
	        </tr>
	        <tr>
	            <td>제 목</td>
